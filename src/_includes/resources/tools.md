...
- [**OS Faults**: An OpenStack fault injection library](https://github.com/openstack/os-faults)
- [Curated list of resources on **testing distributed systems**.](https://github.com/asatarin/testing-distributed-systems)
- [**Anarchy Ape**: Fault injection tool for Hadoop clusters](https://github.com/david78k/anarchyape)
- [**Hadoop Killer**: A process-based fault injector for Java](https://github.com/oza/hadoop-killer)